...
![image-20200519142038416](https://onlythepiano.github.io/images/image-20200519142038416.png)
...
![image-20200623103415938](https://onlythepiano.github.io/images/image-20200623103415938.png)
...
static 修饰的方法是属于类的，该方法的调用者可能是一个类，而不是对象，因而 supe 限定也就失去了意义。
...
![image-20200519143917612](https://onlythepiano.github.io/images/image-20200519143917612.png)
...
![image-20200519144243570](https://onlythepiano.github.io/images/image-20200519144243570.png)

使用super调用和使用this 调用也很像，区别在于super调用的是其父类的构造器，而this调用的是同一个类中重载的构造器。因此，使用super调用父类构造器也必须出现在子类构造器执行体的第一行， 所以this调用和super调用不会同时出现。从上面运行过程来看，创建任何对象总是从该类所在继承树最项层类的构造器开始执行，然后依次向下执行，最后才执行本类的构造器。如果某个父类通过this 调用了同类中重载的构造器，就会依次执行此父类的多个构造器。



![image-20200519144422237](https://onlythepiano.github.io/images/image-20200519144422237.png)
...
![image-20200519153301166](https://onlythepiano.github.io/images/image-20200519153301166.png)
